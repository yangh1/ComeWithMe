...
public class PendingEventAdapter extends RecyclerView.Adapter< PendingEventAdapter.ViewHolder>{
    private Context mContext;
    private ArrayList<Event> mEvents = new ArrayList<>();
    private PendingEventFragment mPendingEventFragment;
    private String uid;
    private String username;
    private String email;
    private Firebase mEventRef;

    public PendingEventAdapter(PendingEventFragment pendingEventFragment, String uid){
        mContext = pendingEventFragment.getContext();
        mEventRef = new Firebase(Constants.EVENT_URL);
        mEventRef.addChildEventListener(new AttendeeChildEventListener());
        mPendingEventFragment = pendingEventFragment;
        username = SharedPreferencesUtils.getUserUsername(pendingEventFragment.getContext());
        email = SharedPreferencesUtils.getUserEmail(pendingEventFragment.getContext());
        this.uid =uid;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_view_pending_event, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener{
        ...
        public ViewHolder(View itemView) {
            ...
            eventHost= (TextView) itemView.findViewById(R.id.event_host_text_view);
            evenTime = (TextView) itemView.findViewById(R.id.event_data_text_view);
            eventLocation = (TextView) itemView.findViewById(R.id.event_location_text_view);
            statusButton = (Button) itemView.findViewById(R.id.user_status_button);
            statusButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    for(String a : e.getAttendees().keySet()){
                        if(e.getAttendees().get(a).getEmail().equals(SharedPreferencesUtils.getUserEmail(mPendingEventFragment.getContext()))){
        ...
        public void onClick(View v) {
            ...
            df.show(mPendingEventFragment.getFragmentManager(), "show attendees");
        }

        @Override
        public boolean onLongClick(View v) {
            mPendingEventFragment.showEditDialog(mEvents.get(getAdapterPosition()));
            return true;
        }
    }

    public void editEvent(Event event){
            String host = SharedPreferencesUtils.getUserUsername(mPendingEventFragment.getContext())+" "
                    +SharedPreferencesUtils.getUserEmail(mPendingEventFragment.getContext());
            ...
            if(event.getHost().equals(host)){
                FragmentTransaction ft = mPendingEventFragment.getActivity().getSupportFragmentManager().beginTransaction();
